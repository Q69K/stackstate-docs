...
* should the StackState k8s agent be installed automatically \(interactively a yes/no question, also enabled when specifying `-k`\): StackState has built-in support \(via the [Kubernetes StackPack](https://github.com/StackVista/stackstate-docs/tree/e37b81c3f21a355624006ddadeff5effa342d734/integrations/kubernetes.md)\) for Kubernetes that can be automatically enabled, see this [section](./#automatic-kubernetes-support).
